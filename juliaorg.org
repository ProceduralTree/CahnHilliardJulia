...
anim = @animate for i in 1:n
    ...
    h = heatmap(testgrd[1].phase , clim =(-1,1) , framestyle=:none , legend=false, lims=(1,size(testgrd[1].phase)[1]), aspect_ratio=:equal )
    push!(massbal , norm(testgrd[1].phase))
    p = plot(1:i , massbal , xlim=(1,n), aspect_ratio=:equal )
    plot(h, p;)
end
gif(anim , "images/iteration_4.gif" , fps = 10)
#+end_src
