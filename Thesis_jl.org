...
p = plot([L"1024 \to 512" , L"512 \to 256" , L"256\to128" , L"128\to64" , L"64 \to32"],change , ylabel = "difference" , yscale=:log10, xlabel = "gridsize" , label=L"\Delta \phi" , xscale=:log2 , seriestype=:scatter , xaxis=:flip , legend=:topright)
