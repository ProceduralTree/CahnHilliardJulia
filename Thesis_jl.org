...
v_large = zeros(size(d_large))
    ...
    solver.phase .+= prolong(u_large)
    solver.potential .+= prolong(v_large)
    # smooth again:
...
#+begin_src julia-vterm :results file graphics  :file iteration.svg :noweb strip-export :async t :exports results :output-dir images  :tangle plot.jl :session jl
include("/home/jon/Projects/julia_tst/utils.jl")
include("/home/jon/Projects/julia_tst/multisolver.jl")
#+end_src
* Relaxed Problem
