#+title: A numerical method on the Cahn-Hilliard equation  and its relaxed variation.
...
#+begin_src julia-vterm :results file graphics :file double-well.svg :eval t
using Plots
using LaTeXStrings
W(x) = 1/4 * (1- x^ 2)^2
...
#+begin_src julia-vterm :results file graphics :file domain.svg :eval t
using Plots
using LaTeXStrings
pgfplotsx()
...
#+begin_src julia-vterm :results graphics file :file alpha-error.svg :eval t
using JLD2
using DataFrames
using Measures
using LaTeXStrings
...
#+begin_src julia-vterm :results file graphics :file relaxed-comparison.svg :eval t
<<init>>
using JLD2
using DataFrames
using Measures
