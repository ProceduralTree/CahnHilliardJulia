...
change = [norm(df[!, "phase"][i] .- restrict(df[! , "phase"][i-4] , G))/*(size(df[!,"phase"][i])...) for i=17:16:size(df , 1)]
...
#+RESULTS[8c06c1becc5715efed9a81b6c9359d8fdf4146c9]: fig:relaxed-stability-in-space
...
#+RESULTS[20827d9a0de8055b906a95ca1fbaa96f9d92a771]: fig:alpha-error
